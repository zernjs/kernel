...
import './middleware/error-middleware.test.js';
import './utils/error-utils.test.js';
import './integrations/event-bus-integration.test.js';
import './integrations/plugin-integration.test.js';
...
import { ErrorCategory, ErrorSeverity } from './types/base.js';
